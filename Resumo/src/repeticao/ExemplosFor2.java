...
public class ExemplosFor2 {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Random aleatorio = new Random();
        int valorBuscado, valorGerado, indice=0;
        boolean achou = false;
        String continua;
        int op;
        ...
        do {
            ...
            System.out.println("2. Buscar um Numero e Imprimir o indice dele");
            ...
            switch (op){
                ...
                case 2:
                    ...
                    valorBuscado = input.nextInt();
                    for (int x =0; x < 10; x++){
                        valorGerado = aleatorio.nextInt(0, 10);
                        System.out.println("valor gerado: " + valorGerado);
                        if(valorBuscado == valorGerado){
                            achou = true;
                            indice = x;
                        }
                        if (achou){
                            System.out.println("O valor " + valorBuscado
                                    + " esta na posição: " + indice);
                            break;
                        }
                    }
                    break;
